let athletes = [
    { name: "Arshad Nadeem", dec:"Arshad Nadeem (born January 2, 1997, Mian Channu, Punjab, Pakistan) is the first Pakistani track-and-field athlete to win an Olympic medal—a feat he accomplished with no less than a gold medal in the men's javelin throw event at the 2024 Paris Games", img: "asset/img/atheletes/Arshad-Nadeem.webp" },
    ...
    { name: "Simone Biles", dec: "Biles stormed the gymnastics scene when she won five medals at the 2016 Olympic Games in Rio: gold in the team event, the individual all-around competition, the vault and the floor exercise. She also took home the bronze in the balance beam final. The athlete set an American record for most gold medals won at a single Games.", img: "asset/img/atheletes/Simone-Biles-Then-Olympic-Athletes-Where-Are-They-Now.jpg" },
...
let games = [
    { title: "Acrobatic Gymnastics", pic: "asset/img/Games/Acrobatic Gymnastics.png" },
    { title: "Alpine Skiing", pic: "asset/img/Games/Alpine Skiing.svg" },
    { title: "Archery", pic: "asset/img/Games/Archery.svg" },
    { title: "Artistic Swimming", pic: "asset/img/Games/Artistic Swimming.svg" },
    { title: "Athletics", pic: "asset/img/Games/Athletics.svg" },
    { title: "Badminton", pic: "asset/img/Games/Badminton.svg" },
    { title: "Beach Volleyball", pic: "asset/img/Games/Beach Volleyball.svg" },
    { title: "Boxing", pic: "asset/img/Games/Boxing.svg" },
    { title: "Breaking", pic: "asset/img/Games/Breaking.svg" },
    { title: "Fencing", pic: "asset/img/Games/Fencing.svg" },
    { title: "Figure Skating", pic: "asset/img/Games/Figure Skating.svg" },
    { title: "Football", pic: "asset/img/Games/Football.svg" },
    { title: "Freestyle Skiing", pic: "asset/img/Games/Freestyle Skiing.svg" },
    { title: "Hockey", pic: "asset/img/Games/Hockey.svg" },
    ...
    { title: "Jumping", pic: "asset/img/Games/Ski Jumping.svg" },
];
...
const olympicRecords = [
    ...
    },
    {
        ...
        record: "8:04.79",
        year: 2016,
        olympicGames: "Rio de Janeiro 2016"
    },
    {
        sport: "Gymnastics",
        athleteName: "Nadia Comăneci",
        country: "Romania",
        event: "Balance Beam",
        record: "Perfect 10",
        year: 1976,
        olympicGames: "Montreal 1976"
    },
    {
        sport: "Weightlifting",
        athleteName: "Lasha Talakhadze",
        country: "Georgia",
        event: "Super-Heavyweight (Total)",
        record: "484 kg",
        year: 2020,
    ...
    {
        sport: "Long Jump",
        athleteName: "Bob Beamon",
        country: "USA",
        event: "Men’s Long Jump",
        record: "8.90 m",
        year: 1968,
        olympicGames: "Mexico City 1968"
    },
    {
        sport: "Pole Vault",
        athleteName: "Sergey Bubka",
        country: "USSR",
        event: "Men’s Pole Vault",
        record: "6.15 m",
        year: 1988,
        olympicGames: "Seoul 1988"
    },
    {
        sport: "Javelin Throw",
        athleteName: "Jan Železný",
        country: "Czech Republic",
        event: "Men’s Javelin Throw",
        record: "98.48 m",
        year: 1996,
        olympicGames: "Atlanta 1996"
    },
    {
        sport: "High Jump",
        athleteName: "Javier Sotomayor",
        country: "Cuba",
        event: "Men’s High Jump",
        record: "2.45 m",
        year: 1992,
        olympicGames: "Barcelona 1992"
    }
];
